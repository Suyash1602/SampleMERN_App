    ...
    return (
        <>
            ...
            <div className="container">
                <h3 className="bg-warning w-25 text-center rounded mx-auto">All Products</h3>
                        ...
                        return (<div class="col-sm-4">
                            <div class="card " key={i}>
                                <div class="card-body">
                                    ...
                                    <p class="card-text fw-semibold">{obj.price}</p>
                                    {/* <button className='btn btn-warning'>Add to Cart</button> */}
                                    <button onClick={() => addToCart(obj)} className='btn btn-warning'>Add to Cart</button>
                                </div>
                            </div>
                        </div>)
                    })}
